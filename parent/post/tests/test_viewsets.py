...
class TestPostViewSet:
    ...
    # For these tests, we are forcing authentication. 
    # We want to make sure that authenticated users have access to the post’s resources
    ...
    # write a test method for post creation, updating, and deletion:  
    ...
    # for the anonymous users, we want them to access the resource in reading mode, 
    # so they can’t create, modify, or delete a resource. 
